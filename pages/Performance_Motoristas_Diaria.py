...
if data_inicial and data_final:
    ...
    if tipo_analise=='Tipo de Veículo' and tipo_de_veiculo:
        ...
        with row2[0]:
            ...
            grafico_duas_barras_linha_percentual(df_tipo_veiculos, 'Apenas Data', 'serviços', 'Serviços', 'meta_batida', 'Metas Batidas', 'performance', 'Performance', 
                                                tipo_de_veiculo)
        ...
        if veiculo:
            ...
            with row2[0]:
                ...
                grafico_duas_barras_linha_percentual(df_veiculos, 'Apenas Data', 'serviços', 'Serviços', 'meta_batida', 'Metas Batidas', 'performance', 'Performance', 
                                                    veiculo)
        ...
        with row2[0]:
            ...
            grafico_duas_barras_linha_percentual(df_motorista, 'Apenas Data', 'serviços', 'Serviços', 
